...
@section('title', 'Tambah Item Tambahan')
    ...
    <div class="p-8">
        <div class="max-w-xl mx-auto">
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-black text-zinc-900 tracking-tighter uppercase italic">Tambah Item</h1>
            </div>

            <div class="bg-white border border-zinc-200 rounded-sm shadow-sm p-8">
                <form action="{{ route('tambahan.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="nama_item" id="nama_item" required
                            ...
                            placeholder="Contoh: Helm Cross, Goggle">
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            <label for="stok_total"
                                ...
                                Total</label>
                            <input type="number" name="stok_total" id="stok_total" required
                                class="w-full bg-zinc-50 border border-zinc-200 p-3 rounded-sm focus:outline-none focus:border-zinc-900 transition"
                                placeholder="Qty">
                        </div>
                    </div>
