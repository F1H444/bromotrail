        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white border border-zinc-200 p-8 shadow-sm">
                <div class="mb-8">
                    ...
                    <p class="text-zinc-500 text-sm mt-1">Silakan masukkan detail Anda untuk masuk.</p>
                </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"
                                    class="text-[10px] font-bold uppercase tracking-widest text-zinc-400 hover:text-zinc-900 transition-colors">
                                    Lupa Password?
                                </a>
                            @endif
                        </div>
                ...
                <div class="mt-8 pt-8 border-t border-zinc-100">
                    <p class="text-center text-sm text-zinc-600">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-bold text-zinc-900 hover:underline">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
